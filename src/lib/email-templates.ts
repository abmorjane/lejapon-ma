...
export const REQUIRED_EMAIL_TEMPLATES: EmailTemplateDefinition[] = [
  ...
  {
    key: "client_portal_invitation",
    name: "Invitation espace client — Mon voyage",
    category: "Réservations",
    subject: "Votre espace voyage LeJapon.ma est prêt — {{booking_reference}}",
    bodyHtml: shell(
      "Votre espace voyage LeJapon.ma est prêt",
      "<p>Bonjour {{client_first_name}},</p><p>Votre espace voyage est disponible pour votre réservation <strong>{{booking_reference}}</strong>.</p><p><strong>Voyage :</strong> {{trip_title}}</p><p>Connectez-vous avec l’email utilisé lors de votre réservation. Si vous n’avez pas encore de mot de passe, utilisez le bouton <strong>Créer mon mot de passe</strong> sur la page de connexion.</p><p>Si vous avez déjà un compte, ce même bouton vous permet de récupérer votre accès.</p><p><a href=\"{{login_link}}\">Accéder à mon espace voyage</a></p>"
    ),
    bodyText: "Bonjour {{client_first_name}},\n\nVotre espace voyage est disponible pour votre réservation {{booking_reference}}.\nVoyage : {{trip_title}}\n\nConnectez-vous avec l'email utilisé lors de votre réservation. Si vous n'avez pas encore de mot de passe, utilisez le bouton Créer mon mot de passe sur la page de connexion.\nSi vous avez déjà un compte, ce même bouton vous permet de récupérer votre accès.\n\nAccéder : {{login_link}}\n\nL'équipe LeJapon.ma",
    allowedVariables: common,
    requiredVariables: ["client_first_name", "booking_reference", "trip_title", "login_link"],
  },
  {
  ...
  {
    key: "client_password_recovery",
    name: "Création / récupération mot de passe client",
    category: "Système",
    subject: "Créez ou réinitialisez votre mot de passe LeJapon.ma",
    bodyHtml: shell(
      "Créer mon mot de passe",
      "<p>Bonjour {{client_name}},</p><p>Vous pouvez créer ou réinitialiser le mot de passe de votre espace voyage LeJapon.ma avec le lien ci-dessous.</p><p><a href=\"{{recovery_link}}\">Créer mon mot de passe</a></p><p>Si vous n'avez pas demandé cet accès, vous pouvez ignorer cet email.</p>",
    ),
    bodyText: "Bonjour {{client_name}},\n\nCréez ou réinitialisez votre mot de passe LeJapon.ma : {{recovery_link}}\n\nSi vous n'avez pas demandé cet accès, vous pouvez ignorer cet email.\n\nL'équipe LeJapon.ma",
    allowedVariables: common,
    requiredVariables: ["recovery_link"],
  },
  {
    key: "admin_password_recovery",
    name: "Récupération mot de passe admin",
    category: "Système",
    subject: "Réinitialisation mot de passe admin — LeJapon.ma",
    bodyHtml: shell(
      "Réinitialisation mot de passe admin",
      "<p>Une demande de réinitialisation du mot de passe admin LeJapon.ma a été effectuée.</p><p><a href=\"{{recovery_link}}\">Créer un nouveau mot de passe</a></p><p>Si vous n'êtes pas à l'origine de cette demande, ignorez cet email et vérifiez votre compte.</p>",
    ),
    bodyText: "Réinitialisez votre mot de passe admin LeJapon.ma : {{recovery_link}}\n\nSi vous n'êtes pas à l'origine de cette demande, ignorez cet email.",
    allowedVariables: common,
    requiredVariables: ["recovery_link"],
  },
  {
...
export function sampleVariablesForTemplate(definition: EmailTemplateDefinition) {
  const defaults: Record<string, string> = {
    ...
    login_link: "https://www.lejapon.ma/espace-voyage/login",
    recovery_link: "https://lejapon.ma/espace-voyage/nouveau-mot-de-passe?token_hash=exemple&type=recovery",
