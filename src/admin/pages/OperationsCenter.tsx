...
const sectionConfig = [
  ...
  { key: "hotelsPending", title: "Hotels pending", icon: Hotel, href: "/admin/supplier-costs", tone: "text-orange-700", description: "Lignes hôtels fournisseur à confirmer." },
  { key: "guidesPending", title: "Guides pending", icon: UserRoundCheck, href: "/admin/supplier-costs", tone: "text-orange-700", description: "Guides non confirmés." },
  { key: "transportPending", title: "Transport pending", icon: Train, href: "/admin/supplier-costs", tone: "text-orange-700", description: "Transport fournisseur non confirmé." },
    ...
    try {
      ...
      const supplierRowToItem = (row: any, section: "hotels" | "guides" | "transport"): OpsItem => {
        ...
        return {
          ...
          status: row.status,
          href: quote?.trip_id ? `/admin/supplier-costs/${quote.trip_id}/${quote.id}` : "/admin/supplier-costs",
      ...
      const supplierQuotesPending = activeSupplierQuotes
        ...
        .map((row: any): OpsItem => ({
          ...
          href: row.trip_id ? `/admin/supplier-costs/${row.trip_id}/${row.id}` : "/admin/supplier-costs",
