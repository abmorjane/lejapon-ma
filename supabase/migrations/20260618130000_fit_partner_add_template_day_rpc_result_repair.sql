-- Répare le contrat de retour de la RPC d'ajout de journée partenaire/sales.
-- Utile si la migration 20260618120000 a déjà été appliquée avant cette correction.
